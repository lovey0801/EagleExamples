...
public class LottieDrawable extends Drawable implements Drawable.Callback {
    ...
    @Nullable
    private AbstractImageBitmapManager imageBitmapManager;
    @Nullable
     ...
     */
    @SuppressWarnings("WeakerAccess")
    public void setImagesFolder(@Nullable String imageAssetsFolder) {
        this.imagesFolder = imageAssetsFolder;
    }
    ...
    public void recycleBitmaps() {
        if (imageBitmapManager != null) {
            imageBitmapManager.recycleBitmaps();
        }
    }
     ...
     */
    @SuppressWarnings({"unused", "WeakerAccess"})
    public void setImageDelegate(
            @SuppressWarnings("NullableProblems") ImageDelegate imageDelegate) {
        this.imageDelegate = imageDelegate;
        if (imageBitmapManager != null) {
            imageBitmapManager.setAssetDelegate(imageDelegate);
        }
    }
    ...
    Bitmap getImageAsset(String id) {
        return getImageBitmapManager().bitmapForId(id);
    }

    private AbstractImageBitmapManager getImageBitmapManager() {
        if (imageBitmapManager != null && !imageBitmapManager.hasSameContext(getContext())) {
            imageBitmapManager.recycleBitmaps();
            imageBitmapManager = null;
        }

        if (imageBitmapManager == null) {
            imageBitmapManager = AbstractImageBitmapManager.createImageBitmapManager(composition.getLottieType(), getCallback(),
                    imagesFolder, imageDelegate, composition.getImages());
        }

        return imageBitmapManager;
    }
