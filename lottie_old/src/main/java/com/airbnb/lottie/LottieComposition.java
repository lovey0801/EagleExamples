...
public class LottieComposition {
    ...
    public static final int LOTTIE_TYPE_ASSETS = 0;
    public static final int LOTTIE_TYPE_FILES = 1;

    private final Map<String, List<Layer>> precomps = new HashMap<>();
    private final Map<String, LottieImage> images = new HashMap<>();
    ...
    private final int lottieType;

    private LottieComposition(int lottieType,
    ...
    Map<String, LottieImage> getImages() {
        return images;
    }
    ...
    public static class Factory {
        ...
        public static Cancellable fromAnimationName(Context context, String animationName, int lottieType, OnCompositionLoadedListener loadedListener) {
            switch (lottieType) {
                case LOTTIE_TYPE_ASSETS:
                    return fromAssetFileName(context, animationName, loadedListener);
                default:
                    return fromFileAsync(context, animationName, loadedListener);
            }
        }
        ...
        public static Cancellable fromAssetFileName(Context context, String fileName,
            ...
            return fromInputStream(context, LottieComposition.LOTTIE_TYPE_ASSETS, stream, loadedListener);
        }
         ...
         */
        public static Cancellable fromInputStream(Context context, int lottieType, InputStream stream,
                                                  OnCompositionLoadedListener loadedListener) {
            FileCompositionLoader loader =
                    new FileCompositionLoader(context.getResources(), lottieType, loadedListener);
            loader.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, stream);
            return loader;
        }

        @SuppressWarnings("WeakerAccess")
        public static Cancellable fromFileAsync(Context context, String fileName, OnCompositionLoadedListener loadedListener) {
            InputStream stream;
            try {
            ...
            return fromInputStream(context, LOTTIE_TYPE_FILES, stream, loadedListener);
        }
        ...
        public static LottieComposition fromFileSync(Context context, String fileName) {
            ...
            return fromInputStream(context.getResources(), LOTTIE_TYPE_FILES, stream);
        }
         ...
         * network.
         */
        public static Cancellable fromJson(Resources res, int lottieType, JSONObject json,
                                           OnCompositionLoadedListener loadedListener) {
            JsonCompositionLoader loader = new JsonCompositionLoader(res, lottieType, loadedListener);
            loader.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, json);
            return loader;
        }

        @SuppressWarnings("WeakerAccess")
        static LottieComposition fromInputStream(Resources res, int lottieType, InputStream stream) {
            try {
                ...
                return fromJsonSync(res, lottieType, jsonObject);
            } catch (IOException e) {
        ...
        @SuppressWarnings("WeakerAccess")
        static LottieComposition fromJsonSync(Resources res, int lottieType, JSONObject json) {
            Rect bounds = null;
            ...
            LottieComposition composition =
                    new LottieComposition(lottieType, bounds, startFrame, endFrame, frameRate, scale);
        ...
        private static void parseImages(
            ...
            for (int i = 0; i < length; i++) {
                ...
                LottieImage image = LottieImage.Factory.newInstance(assetJson);
