...
class ImageAssetBitmapManager {
  ...
  private final Map<String, LottieImage> imageAssets;
  private final Map<String, Bitmap> bitmaps = new HashMap<>();

  ImageAssetBitmapManager(Drawable.Callback callback, String imagesFolder,
      ImageAssetDelegate assetDelegate, Map<String, LottieImage> imageAssets) {
  ...
  Bitmap bitmapForId(String id) {
    ...
    if (bitmap == null) {
      LottieImage imageAsset = imageAssets.get(id);
      if (imageAsset == null) {
        return null;
      }
