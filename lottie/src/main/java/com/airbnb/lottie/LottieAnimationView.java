...
import com.yibasan.lizhifm.lottie.R;
 ...
 * 2) Programatically: {@link #setAssetAnimation(String, String)}, {@link #setComposition(LottieComposition, String)},
 * or {@link #setAnimation(JSONObject, String, int)}.
 * <p>
...
public class LottieAnimationView extends AppCompatImageView {
    ...
    private final OnCompositionLoadedListener loadedListener =
            new OnCompositionLoadedListener() {
                ...
                public void onCompositionLoaded(LottieComposition composition) {
                    setComposition(composition, lottieDrawable.getImagesFolder());
    ...
    private void init(@Nullable AttributeSet attrs) {
        ...
        if (!isInEditMode() && fileName != null) {
            setAssetAnimation(fileName, ta.getString(R.styleable.LottieAnimationView_lottie_imageAssetsFolder));
        }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        this.lottieType = ss.lottieType;
        String imagesFolder = ss.imagesFolder;
        if (!TextUtils.isEmpty(animationName)) {
            setAnimation(animationName, imagesFolder, lottieType, defaultCacheStrategy);
        }
        ...
        lottieDrawable.setImagesFolder(ss.imagesFolder);
    }
     ...
     */
    @SuppressWarnings("WeakerAccess")
    public void setAssetAnimation(String animationName, String imagesFolder) {
        setAnimation(animationName, imagesFolder, LottieComposition.LOTTIE_TYPE_ASSETS, defaultCacheStrategy);
    }
     ...
     */
    @SuppressWarnings("WeakerAccess")
    private void setAnimation(final String animationName, final String imagesFolder, final int lottieType, final CacheStrategy cacheStrategy) {
        ...
        if (weakRefCache.containsKey(animationName)) {
            ...
            if (compRef.get() != null) {
                setComposition(compRef.get(), imagesFolder);
                return;
            }
        } else if (strongRefCache.containsKey(animationName)) {
            setComposition(strongRefCache.get(animationName), imagesFolder);
            return;
        }
        ...
        OnCompositionLoadedListener listener = new OnCompositionLoadedListener() {
            ...
            public void onCompositionLoaded(LottieComposition composition) {
                ...
                setComposition(composition, imagesFolder);
            }
        };

        compositionLoader = LottieComposition.Factory.fromAnimationName(getContext(), animationName, lottieType, listener);
    }
     ...
     */
    public void setAnimation(final JSONObject json, String imagesFolder, int lottieType) {
        cancelLoaderTask();
        lottieDrawable.setImagesFolder(imagesFolder);
        compositionLoader = LottieComposition.Factory.fromJson(getResources(), lottieType, json, loadedListener);
    }
     ...
     */
    public void setComposition(@NonNull LottieComposition composition, String imagesFolder) {
        if (L.DBG) {
...
//    }
     ...
     */
    @SuppressWarnings("unused")
    public void setImageDelegate(ImageDelegate assetDelegate) {
        lottieDrawable.setImageDelegate(assetDelegate);
    }
